...
/**
 * Servlet implementation class QnaBoardUpadateEndServlet
 */
@WebServlet("/board/boardUpdateEnd")
public class QnaBoardUpadateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaBoardUpadateEndServlet() {
        super();
...
//		C:\Users\msi\git\triptaxi\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\triptaxi\/upload/board
		...
		int qnaNo=Integer.parseInt(mr.getParameter("boardNo"));
		...
		int result=new BoardService().updateBoardEnd(b);
		
		String msg="";
		String loc="";
		String view="/views/common/msg.jsp";
		if(result>0) {
			loc="/board/boardView?no="+qnaNo;
			msg="수정성공";
		}else {
			loc="/board/boardList";
			msg="수정실패";
