...
<%@ page import="com.kh.board.model.vo.BoardComment,java.util.List" %>
<%
   ...
   table#tbl-comment tr.level2 sub.comment-date {color:#ff9c8a; font-size:10px}
		...
		<table id="tbl-board">
			...
			<tr>
				<th>첨부파일</th>
				<td>
				 <%if(b.getBoardOriFile()!=null){ %>
				 	<img src="<%=request.getContextPath()%>/images/file.png"
				 	width="6px"/><%=b.getBoardOriFile() %>
				 <%} %>
				</td>
			</tr>
			<tr>
    ...
    function fn_deleteBoardComment(){
    	location.href='<%=request.getContextPath()%>/board/boardCommentDelete?boardRef='+$("#btn-delete").val;
    }
